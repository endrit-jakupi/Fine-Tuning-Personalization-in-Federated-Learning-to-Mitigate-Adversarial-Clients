...
save_folder = f'./experiments/{config["dataset"]}/{config["heterogeneity"]}/n_{config["n"]}_m_{config["m"]}_f_{config["f"]}_T_{config["T"]}_runs_{config["nb_run"]}_alpha_{config["alpha"]}'
